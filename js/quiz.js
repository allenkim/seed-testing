...
(function($) {
    $.fn.quiz = function(spreadsheet_id,sheetName) {
        this.quiz = $.quiz(spreadsheet_id,sheetName);
        return this;
    };
    ...
    $.quiz = function(spreadsheet_id,sheetName) {
        var container_elem;
        var self;
        var cover;
        ...
        var quiz = {
            ...
            init : function(spreadsheet_id,sheetName) {
                self = this;

                // Google spreadsheet ID provided
                // Will call init_data in a callback
                self.load_from_google_spreadsheet(spreadsheet_id,sheetName);
            ...
            load_from_google_spreadsheet: function(spreadsheet_id,sheetName) {
                Tabletop.init({ 
                    ...
                    callback: function(data) {
                        console.log(data)
                        var quiz_data = self.make_quiz_data_from_spreadsheet_data(data,sheetName);
            ...
            make_quiz_data_from_spreadsheet_data: function(tabletop,sheetName) {
        ...
        return quiz.init(spreadsheet_id,sheetName);
    };
})(jQuery);
